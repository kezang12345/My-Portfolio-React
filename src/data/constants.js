export const Bio = {
  ...
  github: "https://github.com/kezang12345",
  resume:
    "https://drive.google.com/file/d/1tPn7tFrbsmLiCGF7SZTZpwFDHL0rfyov/view?usp=sharing",
...
export const experiences = [
  {
    ...
    desc: "HTML, or Hypertext Markup Language, is the standard language used to create and design web pages. It provides the structure for web content by using a system of tags and attributes. These tags define the different parts of a webpage, such as headings, paragraphs, images, links, and more.",
    // skills: [
    //   "ReactJS",
    //   "Redux",
    //   "NodeJs",
  ...
  },
  {
    ...
    desc: "CSS, or Cascading Style Sheets, is a stylesheet language used to describe the presentation of a document written in HTML or XML. It defines how elements should be displayed on a web page, including layout, colors, fonts, and other visual aspects.",
    // skills: [
    //   "Docker",
    //   "Terraform",
    //   "AWS",
  ...
  },
  {
    ...
    desc: "JavaScript is a high-level, interpreted programming language that is used to make web pages interactive and dynamic. It can be embedded directly into HTML code or included from external files. JavaScript code is executed by the browser, allowing for actions to be taken on the page in response to user input or other events.",
    // skills: [
    //   "Android",
    //   "Java",
    //   "Kotlin",
  ...
  },
  {
    ...
    desc: "Bootstrap is a popular front-end framework for building responsive and mobile-first websites and web applications. It provides a collection of CSS and JavaScript components that make it easier to design and layout web pages, including buttons, forms, navigation bars, and more.",
    // skills: [
    //   "ReactJS",
    //   "Redux",
    //   "NodeJs",
  ...
  {
    id: 4,
    img: "https://upload.wikimedia.org/wikipedia/commons/thumb/3/30/React_Logo_SVG.svg/180px-React_Logo_SVG.svg.png",
    role: "React",
    date: "Nov2021 - Present",
    desc: "React is a JavaScript library for building user interfaces, particularly single-page applications where data can change over time. It's maintained by Facebook and a community of developers and provides a declarative and component-based approach to building UIs.",
    // skills: [
    //   "Leadership",
  ...
  {
    id: 5,
    img: "https://miro.medium.com/v2/resize:fit:800/1*v2vdfKqD4MtmTSgNP0o5cg.png",
    role: "Node.js",

    date: "May 2023 - Present",
    desc: "Node.js is an open-source, server-side JavaScript runtime environment that allows you to run JavaScript code outside of a web browser. It uses the V8 JavaScript engine from Google Chrome to execute code, making it fast and efficient. Node.js is commonly used for building web servers and other network applications, but it can also be used for a wide variety of other purposes, including building command-line tools and desktop applications.",
  },
];
...
export const education = [
  {
    id: 0,
    school: "Tendruk High school",
    date: "Feb 2017 - Nov 2020",
    grade: "12",
    desc: "I completed my High school from tendruk high school where i studied Arts and Rigzung.",
  },
  {
    id: 1,
    school: "Norbugang Lower School",
    date: "Feb 2007 - Dec 2016",
    grade: "8",
    desc: "I have completed my primary and lower school from Norbugang Lower school",

  },
  {
    id: 2,
    school: "ICT Foundation",
    date: "Aug 2023 - sep 2023",
    desc: "I have completed ICT Foundation from Younphula DSP center for one month ",

  },
  {
    id: 3,
    school: "Introduction to Coding",
    date: " Sep 2023 -  Nov 2023",
    desc: "I have completed Introduction to coding for two month from Younphula DSP center",
...

  {
    ...
    date: " Dec 2023 -  April 2023",
    desc: "I have completed Web Development for four month from Gyalposhing DSP center",
